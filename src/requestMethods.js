...
const TOKEN = JSON.parse(localStorage.getItem("persist:root")).user !== null ? JSON.parse(JSON.parse(localStorage.getItem("persist:root")).user).currentUser.accessToken : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyMDliNmU0MjUyZDEzNDZmZDdjMzhjZCIsImlzQWRtaW4iOnRydWUsImlhdCI6MTY1MjQ3MzU5MSwiZXhwIjoxNjUyNzMyNzkxfQ.0bMmXHXJPNQOtX4wHUcwZJTw14VfJecmAm5CGX4dF2E";
